...
import torch
import math
from object_feature_rasterization import GaussianRasterizationSettings, GaussianRasterizer
...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    ...
    object_feature = pc.get_object_feature
    # Rasterize visible Gaussians to image, obtain their radii (on screen). 
    rendered_image, rendered_feature_map, radii, rendered_depth, rendered_alpha = rasterizer(
        means3D = means3D,
        means2D = means2D,
        shs = shs,
    ...
    return {"render": rendered_image,
            "render_object_feature": rendered_feature_map,
